...
$data = $conn->getone("pages", "id", $_GET['id']);
...
if(isset($_POST['submit-form'])) {
	...
	if($title == "" OR $body == "")
	{
		$error .= "Please give this page a title and body.";
		$success = false;
	}
	if($success){
		$updatedata = $conn->update("pages", "title='".$title."', urltitle='".$urltitle."', body='".$body."', image='".$_POST['selimage']."', modified='".date('Y-m-d H:i:s')."', author='".$_SESSION["userSession"]."'", $_POST['id']);
