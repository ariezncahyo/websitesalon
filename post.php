...
$conn = new DB();
$data = $conn->getone("posts", "urltitle", "'".$_GET["title"]."'");
$data2 = $conn->getall("posts", "DESC");
...
<div class="gridContainer clearfix">
  ...
  <div id="page">
    ...
    <div id="sidebar"><h2>Other Posts</h2>
    	<?php 
			//loop though the results
			while($f2 = mysqli_fetch_array($data2)){
				echo "<div class='otherposts'><a href='post.php?title=".$f2['urltitle']."'>".$f2['title']."</a></div>";
			}
		  ?>
    </div>
     <div class="clear"></div>
